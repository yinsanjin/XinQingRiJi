package com.jiahaozhang.moodiary.adapter;
...
import com.jiahaozhang.moodiary.ui.EditNoteActivity;
import com.jiahaozhang.moodiary.ui.NoteListFragment;
...
public class NoteListAdapter extends RecyclerView.Adapter<NoteListAdapter.NoteListViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(final NoteListViewHolder holder, final int position) {
        ...
        Glide.with(context).load(currentNote.getImage_id()).into(holder.note_image);
